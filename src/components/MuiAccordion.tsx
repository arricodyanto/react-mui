  ...
  return (
    <div>
        <Accordion expanded={ expanded === 'panel1'} onChange={(event, isExpanded) => handleChange(isExpanded, 'panel1') }>
            ...
            <AccordionDetails>
                <Typography>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Rerum facilis aspernatur quisquam veniam exercitationem ipsam, eos ipsum ut sunt voluptas inventore cum dignissimos dolorum at eveniet, impedit reprehenderit nemo voluptate?</Typography>
            </AccordionDetails>
        </Accordion>
